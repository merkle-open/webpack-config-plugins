 ...
 * @typedef {{
	 ...
	 name: string,
}} ImageConfigWebpackPluginOptions */

'use strict';
/**
 * @type {ImageConfigWebpackPluginOptions}
 */
const defaultOptions = { name: 'static/media/[name].[hash:8].[ext]' };

class ImageConfigWebpackPlugin {
	/**
	 * @param {Partial<ImageConfigWebpackPluginOptions>} options
	 */
	constructor(options = {}) {
